...
import os
import math
from data import SemiSupervisedDataSets, PARSEDICT
...
class FixMatch(BaseModel):
    ...
    def setup_model(self, arch, nclass, wd, lr, momentum, confidence, **kwargs):
    ...
    def train_step(self, labeled_inputs, unlabeled_inputs):
        ...
        with tf.GradientTape() as tape:
            ...
            logits, _ = self.models["classifier"](x, training=True)
            ...
            full_loss =  xe_loss + xep_loss + self.wd*l2_loss
    ...
    def train(self, train_steps, eval_steps):
        ...
        dul = self.datasets.train_unlabeled.shuffle(FLAGS.shuffle).repeat()
